...
public enum Setting
{
    ...
    MOB_LIMITING(Material.PIGLIN_HEAD, "regulations.setting.mob_limiting.name", "regulations.setting.mob_limiting.description", "toggles.mob_limiting", boolean.class, false),
